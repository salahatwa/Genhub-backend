...
import com.genhub.blogapi.security.JwtAuthenticationEntryPoint;
import com.genhub.blogapi.security.JwtAuthenticationFilter;
import com.genhub.blogapi.service.impl.CustomUserDetailsServiceImpl;
...
public class SecutiryConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		http.cors().and().csrf().disable().exceptionHandling().authenticationEntryPoint(unauthorizedHandler).and()
				...
				.antMatchers(HttpMethod.POST, "/api/auth/**").permitAll().antMatchers(HttpMethod.GET,
